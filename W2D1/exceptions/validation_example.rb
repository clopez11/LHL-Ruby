...
begin
  jacob = Name.new(nil,'Berendes') 
rescue ArgumentError => e
  puts "We caught the ArgumentError, show the user something interesting."
  puts e.message
  # puts e.backtrace.inspect
end

  
# puts jacob = Name.new('Jacob', 'Berendes') 
# puts jacob.full_name
# puts jacob.first = 'Mary Sue'  
